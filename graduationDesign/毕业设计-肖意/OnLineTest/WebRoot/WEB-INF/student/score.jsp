                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">卷面信息</div>
                            </div>
                                ...
                                <form class="form-horizontal" action="${pageContext.request.contextPath}/student/subjectManageAction_querySubject.action" method="post">
                                    ...
                                    <div class="col-lg-12 form-group">
                                      ...
                                      <div class="col-lg-3 form-group">
                                        <label >课程:</label>
                                          <label ><s:property value="#request.resultScore.score.subject.course.courseName"/></label>
                                    </div>
                                    
                                    <div class="col-lg-3 form-group">
                                        <label >| 考试时长:</label>
                                          <label ><s:property value="#request.resultScore.score.subject.subjectTime"/>分钟</label>
                                    </div>
                                    
                                    <div class="col-lg-3 form-group">
                                        <label >| 考生姓名:</label>
                                        <input type="hidden" id="test_studentId" value="<s:property value="#request.resultScore.score.student.studentId"/>">
                                          <label ><i><s:property value="#request.resultScore.score.student.studentName"/></i> </label>
                                    </div>
                                    
                                    <div class="col-lg-3  form-group">
                                        <label>| 总得分:</label>
                                          <label id="allSocre"><i><s:property value="#request.resultScore.score.allScore"/>分</i></label>
                                    </div>
                                </form>
                            </div>
                        </div>
